    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <p class="m-0">Sukanta Purkayastha</p>
...
<div class="footer text-muted" style="left: 20px; right: 20px;">
    ...
    <div class="row">
        ...
        <div class="col-xs-4 text-right"><span>iHostel Version: {{config('naz.version')}} | <a href="#" data-toggle="modal" data-target="#credit_show_modal">Credit</a></span></div>
    </div>
